  ...
  if (!accept) {
    ...
    return (
        <div className="subtitle min-h-screen main">
            ...
            alt="chemistry" className=""/>
            </div>
            <button onClick={routing} className=" font-sans mx-40  w-1/4 font-semibold text-2xl rounded-lg bg-linear-to-r from-orange-600 to-red-600 text-white p-2">Начать работу</button>
        </div>
    )
}
